...
public final class ParserRobot202220 {
  ...
  public static IPushdownAutomaton createParser(Object A) {
    ...
    $try:try {
      ...
      V=$cast(String.class,$fix("V"));
      $line=106;
      String commandEnd=null;
      commandEnd=$defaultValue(String.class);
      $line=107;
      commandEnd=$cast(String.class,$fix("U"));
      $line=108;
      String commandBegin=null;
      commandBegin=$defaultValue(String.class);
      $line=109;
      commandBegin=$cast(String.class,$fix("J"));
      $line=113;
      Object Q=$fix(GCollections.asSet("qPROG","q,","qCORP","q2","q1","q;","qPROC","qPROC(","qPROC)","qPROC,","qPROCinstrs","qPROCp","qPROCv","qVAR","qv","qCORP","qBlock","qBlockEnd","qASSIGN","q:=","qInstr;"));
      $line=133;
      Object \u03A3=$fix($opUnionY(ParserRobot202220.toSet(A),GCollections.asSet(' ','\n','\t')));
      $line=135;
      Object \u0393=$fix($opUnionY($opIntvlY('A','Z'),GCollections.asSet('(','v','{')));
      $line=137;
      ...
      $line=183;
      $invokeMethod("pop",((gold.structures.automaton.GPushdownAutomaton)M).delta("qPROCinstrs","qCORP",$cast(java.lang.String.class,'}')),new Object[]{$opAdditY(key,commandEnd)});
      $line=186;
      ...
      $line=189;
      $invokeMethod("pop",((gold.structures.automaton.GPushdownAutomaton)M).delta("qBlock","qBlockEnd",$cast(java.lang.String.class,'}')),new Object[]{$opAdditY(key,commandEnd)});
      $line=192;
      for (Object $v3:GCollections.unmodifiableCollection(GCollections.asSet("qPROCinstrs","qBlock"))) {
        ...
        $line=196;
        $invokeMethod("changeTop",((gold.structures.automaton.GPushdownAutomaton)M).delta("qInstr;","qASSIGN",$cast(java.lang.String.class,v)),new Object[]{commandBegin,v});
        $line=197;
        ...
        $line=198;
        $invokeMethod("changeTop",((gold.structures.automaton.GPushdownAutomaton)M).delta("q:=",qBlock,$cast(java.lang.String.class,"#")),new Object[]{v,commandEnd});
        $line=202;
        $invokeMethod("changeTop",((gold.structures.automaton.GPushdownAutomaton)M).delta(qBlock,"qInstr;",$cast(java.lang.String.class,";")),new Object[]{commandEnd,commandBegin});
      }
      $line=208;
      for (Object $v4:GCollections.unmodifiableCollection(Q)) {
        Object q=$v4;
        $line=209;
        for (Object $v5:GCollections.unmodifiableCollection(SkipChars)) {
          Object s=$v5;
          $line=210;
